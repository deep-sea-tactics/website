...
<style>
	...
	.button::after {
		...
		background-image: linear-gradient(90deg , var(--blue) 0%, var(--blue) 50%, transparent 50%, transparent 100%);
		background-size: 200%;
